     ...
     <div className="wrapper-right">
      ...
      <div className="heading-container">
        ...
        <ul className="Performance_based_list">
         ...
         <div className="radio-button-performance" style={{ paddingLeft: "43px" }}>
              <input
                type="radio"
                name="Attachments"
                value="yes"
              ...
              />{" "}
            Allow
              <input type="radio" name="Attachments" value="no" />Do not Allow
            </div>
          </div>
         </li>
        </ul>
        ...
        <li>
          <div className="radio-input-container">
            ...
            <div className="radio-button-group">
              ...
              />{" "}
             All
              <input type="radio" name="HROverride" value="no" />Group Wise
            </div>
          </div>
        </li>
